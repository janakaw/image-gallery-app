...
urlpatterns = [
    ...
    path('project_cover_image/', views.get_project_cover_image, name='project-cover-image'),
    path('project_image/', views.get_project_image, name='project-image'),
    path('project_image_list/', views.get_project_image_list, name='project-image-list'),
